...
**Kod imzalama secret'ı yok — v0.2.0 bilinçli olarak imzasız yayınlanıyor.**
SignPath.io OSS başvurusu reddedildi (proje çok yeni/reputation yetersiz),
detay ve sonraki adımlar için [CODESIGN.md](./CODESIGN.md) → "Durum" bölümü.
MSI/NSIS imzasız üretilir (SmartScreen "bilinmeyen yayıncı" uyarısı çıkar,
kurulum yine de "Daha fazla bilgi → Yine de çalıştır" ile çalışır).
