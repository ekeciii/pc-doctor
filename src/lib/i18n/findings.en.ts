...
export const findingsEn: Record<FindingCode, string> = {
  ...
  "finding.disk_full.full.recommendation":
    "Run all cleanup targets; remove unnecessary programs if needed.",
  ...
  "finding.disk_full.warning.recommendation": "Clean up temporary files and the update cache.",
  ...
  "finding.driver.unsigned_summary.recommendation":
    "Check for drivers via Windows Update > Advanced options > Optional updates.",
  ...
  // === defender ===
  "finding.defender.active_threats.title": "{threatCount} active threats detected by Defender",
  ...
  "finding.defender.active_threats.recommendation": "Run a Defender Quick Scan.",
  ...
  "finding.defender.rt_off.recommendation":
    "Run a Defender Quick Scan and turn on real-time protection.",
  ...
  "finding.defender.av_off.recommendation":
    "Open Windows Security → Virus & threat protection and turn on the antivirus engine (if you use another AV, keep it up to date).",
  ...
  "finding.defender.sig_stale.recommendation":
    "Pull the latest signature update via Windows Update.",
  ...
  "finding.defender.scan_stale.recommendation": "Run a Defender Quick Scan.",
  ...
  "finding.smart.health.recommendation":
    "Back up your data now and run the manufacturer's diagnostic tool.",
  ...
  "finding.smart.wear_urgent.recommendation":
    "Back up important files immediately and plan an SSD replacement.",
  "finding.smart.wear_routine.recommendation":
    "Keep regular backups of important files; plan a replacement as wear progresses.",
  ...
  "finding.smart.temperature.recommendation":
    "Check the case airflow and drive placement; a heatsink is recommended if it's NVMe.",
  ...
  "finding.smart.io_errors.recommendation": "Back up now; run a chkdsk scan.",
  ...
  "finding.thermal.critical.recommendation":
    "Open the case and clean the fans/airflow; check the thermal paste. On a laptop, use a raised stand + cooling pad.",
  ...
  "finding.thermal.warning.recommendation": "Dust cleaning and an airflow check are recommended.",
  ...
  "finding.thermal.throttling_critical.recommendation":
    "Switch the power plan to 'Best performance'; check cooling; update the BIOS.",
  "finding.thermal.throttling_warning.title": "Mild CPU throttling: {perfPercent}% of nominal",
  ...
  "finding.thermal.throttling_warning.recommendation": "Check the power plan; clean out dust.",
  ...
  "finding.security.firewall_query_failed.recommendation":
    "Open an admin PowerShell and run `Start-Service MpsSvc`.",
  ...
  "finding.security.firewall_off.recommendation":
    "Open Windows Security → Firewall and turn on all profiles.",
  ...
  "finding.security.uac_off.recommendation":
    "Type 'UAC' in the Start menu and pick 'Change User Account Control settings'.",
  ...
  "finding.security.uac_no_prompt.recommendation":
    "Restore the default UAC level (ConsentPromptBehaviorAdmin=5).",
  ...
  "finding.security.bitlocker_off.recommendation":
    "Enable it via Settings → Device encryption (Home) or BitLocker (Pro).",
  ...
  "finding.security.dns_unknown.recommendation": "Review the DNS servers in your network settings.",
  ...
  "finding.security.hosts_suspicious.recommendation":
    "Remove lines you don't recognize from C:\\Windows\\System32\\drivers\\etc\\hosts (open Notepad as administrator).",
  ...
  "finding.updates.wu_security.recommendation":
    "Open Windows Update and start downloading & installing.",
  ...
  "finding.updates.wu_many.recommendation":
    "Install the pending updates from Windows Update. You may need to restart your PC.",
  ...
  "finding.updates.winget.recommendation":
    "Open an admin PowerShell and run `winget upgrade --all --silent` to update every app in one command.",
  ...
  "finding.startup.slow_critical.recommendation":
    "Reduce startup items, check disk health, and review recent driver updates.",
  ...
  "finding.startup.slow_warning.recommendation": "Reduce startup apps; keep Fast Startup enabled.",
  ...
  "finding.startup.too_many.recommendation":
    "Go to Settings → Apps → Startup and disable the ones you don't need.",
  ...
  "finding.crash.wer_many.recommendation":
    "Repair system files with sfc/DISM; check Reliability Monitor for which apps are crashing.",
  ...
  "finding.crash.wer_some.recommendation":
    "Repair system files with sfc/DISM; review the pattern in Reliability Monitor.",
  "finding.crash.top_signature.title": "{signatureCount} reports from '{source}' (most frequent)",
  ...
  "finding.crash.top_signature.recommendation":
    "Repair system files with sfc/DISM; if a specific app or driver keeps failing, update it, remove it, or check the OEM's site.",
  ...
  "finding.event_log.kernel_power_41.recommendation": "Repair system files with sfc/DISM.",
  "finding.event_log.whea_or_bugcheck.title": "Hardware/BSOD signal: {provider} ({count})",
  ...
  "finding.event_log.whea_or_bugcheck.recommendation":
    "Run sfc/DISM; if it continues, test your RAM and disk SMART health.",
  ...
  "finding.event_log.gpu_driver_error.recommendation": "Update the GPU driver from the OEM's site.",
  ...
  "finding.event_log.disk_or_ntfs_error.recommendation":
    "Repair system files with sfc/DISM; run a chkdsk scan.",
